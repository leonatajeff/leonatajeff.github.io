...
function App() {
  ...
  return (
    <div className="App">
      <button class="border-solid border bg-opacity-10 border-gray-300 bg-neutral-50 rounded-full outline-4 px-4 py-2 inline-flex items-center">
        <span className="text-slate-50 font-semibold mr-3">
          Now · Starting a Design Career
        </span>
